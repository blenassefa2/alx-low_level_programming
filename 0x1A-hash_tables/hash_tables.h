 ...
 * use a Chaining collision handeling
 */
 ...
 * @value: The value corresponding to a key
 * @next: A pointer to the next node of the list
 * @sprev: pointer to sorted previous list
 * @snext: pointer to sorted next list
 */
 ...
 * @stail: a pointer to last element of sorted list
 */
